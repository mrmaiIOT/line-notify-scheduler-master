...
const date_travel = {'year':'2021', 'month':'01', 'date':'22'};
// Set the headers
var headers = {
...
if(moment().utcOffset('+0700').format("YYYYMMDDHH") == '2021011308'){
...
//2017041308
if(moment().utcOffset('+0700').format("YYYYMMDDHH") == '2021011313'){
	options.form.message = 'เตรียมหาข้อมูลเที่ยวกระบี่กัน';
	request(options);
}
//2017041713
if(moment().utcOffset('+0700').format("YYYYMMDDHH") == '2021012118'){
...
//2017042118
if(moment().utcOffset('+0700').format("YYYYMMDDHH") == '2021012119'){
	options.form.message = 'อย่าลืม Check-in ผ่านเว็บไซต์นะครับ';
	request(options);
}
//2017042119
if(moment().utcOffset('+0700').format("YYYYMMDDHH") == '2021012206'){
...
//2017042206
if(moment().utcOffset('+0700').format("YYYYMMDDHH") == '2021012212'){
...
//2017042212
if(moment().utcOffset('+0700').format("YYYYMMDDHH") == '2021012217'){
...
//2017042217
if(moment().utcOffset('+0700').format("YYYYMMDDHH") == '2021012412'){
